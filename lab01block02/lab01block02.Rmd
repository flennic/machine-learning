...
The likelihood $L$ is given by the following equation which can be found in [@pattern-recognition] on page 443 equation 9.14.
...
kable(llik[1:it], caption = "Ln-Likelihood")
