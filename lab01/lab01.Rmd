...
print(paste(sep ="", "Missclassification rate: ", (confusion_matrix_train[1,2]+confusion_matrix_train[2,1])/sum(confusion_matrix_train)))
```
...
print(paste(sep ="", "Missclassification rate: ", (confusion_matrix_test[1,2]+confusion_matrix_test[2,1])/sum(confusion_matrix_test)))
```
...
print(paste(sep ="", "Missclassification rate: ", (confusion_matrix_train_two[1,2]+confusion_matrix_train_two[2,1])/sum(confusion_matrix_train_two)))
```
...
print(paste(sep ="", "Missclassification rate: ", (confusion_matrix_test_two[1,2]+confusion_matrix_test_two[2,1])/sum(confusion_matrix_test_two)))
```
