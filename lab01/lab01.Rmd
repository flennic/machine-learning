...
Let's see what the confusion matrices look like. First one is for the training, second one is for the test data.

```{r, echo = FALSE}
kable(confusion_matrix_train, caption = "Confusion Matrix (Training Data)")
kable(confusion_matrix_test,  caption = "Confusion Matrix (Training Data)")
```
...
```{r}
spambase_model_two = glm(as.formula("Spam ~ ."), data = train, family = "binomial")
...
```
Let's see what the confusion matrices look like. First one is for the train_twoing, second one is for the test_two data.

```{r}
print(confusion_matrix_train_two)
print(confusion_matrix_test_two)
```
...
Train the model and apply it on the training and test data.

```{r}
kknn_model_train = kknn(formula = as.formula("Spam ~ ."), train = train, test = train, k = 30)
kknn_model_test = kknn(formula = as.formula("Spam ~ ."), train = train, test = test, k = 30)
...
Confusion matrices:
```{r}
print(confusion_matrix_kkn_train)
print(confusion_matrix_kkn_test)
```
...
```{r}
kknn_model_train_30 = kknn(formula = as.formula("Spam ~ ."), train = train, test = train, k = 1)
kknn_model_test_30 = kknn(formula = as.formula("Spam ~ ."), train = train, test = test, k = 1)

# Train
y_hat_train_30 = apply(as.matrix(kknn_model_train_30$fitted.values), c(1), FUN = function(x) return(x > 0.5))
confusion_matrix_kkn_train_30 = as.matrix(table(y_hat_train_30, train$Spam))

# Test
y_hat_test_30 = apply(as.matrix(kknn_model_test_30$fitted.values), c(1), FUN = function(x) return(x > 0.5))
confusion_matrix_kkn_test_30 = as.matrix(table(y_hat_test_30, test$Spam))
```

Confusion matrices:
```{r}
print(confusion_matrix_kkn_train_30)
print(confusion_matrix_kkn_test_30)
```

Result training:
```{r}
spam_not_detected_train_kknn_30 = confusion_matrix_kkn_train_30[2,1]/sum(confusion_matrix_kkn_train_30[,1])
mail_missclassified_train_kknn_30 = confusion_matrix_kkn_train_30[1,2]/sum(confusion_matrix_kkn_train_30[,2])
print(paste(sep = "", "Spam not detected: ", spam_not_detected_train_kknn_30))
print(paste(sep = "", "Mail missclassified as spam: ", mail_missclassified_train_kknn_30))
print(paste(sep ="", "Misclassification rate: ", (confusion_matrix_kkn_train_30[1,2]+confusion_matrix_kkn_train_30[2,1])/sum(confusion_matrix_kkn_train_30)))
```

Result test:
```{r}
spam_not_detected_test_kknn_30 = confusion_matrix_kkn_test_30[2,1]/sum(confusion_matrix_kkn_test_30[,1])
mail_missclassified_test_kknn_30 = confusion_matrix_kkn_test_30[1,2]/sum(confusion_matrix_kkn_test_30[,2])
print(paste(sep = "", "Spam not detected: ", spam_not_detected_test_kknn_30))
print(paste(sep = "", "Mail missclassified as spam: ", mail_missclassified_test_kknn_30))
print(paste(sep ="", "Misclassification rate: ", (confusion_matrix_kkn_test_30[1,2]+confusion_matrix_kkn_test_30[2,1])/sum(confusion_matrix_kkn_test_30)))
```
