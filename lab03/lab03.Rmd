...
compare_value_day = list(date = "2013-07-01")
compare_value_hour = list(time = "12:30:00")

# 5000
distances = kernel_gauss_distance(compare_value_distance, plot_values_distance, 5000)

# 7
days = kernel_gauss_day(compare_value_day, plot_values_day, 7)

# 26
hours = kernel_gauss_hour(compare_value_hour, plot_values_hour, 26)
...
#                             plot_values_day$date, days,
#                             plot_values_hour$time, hours)
...
ggplot(plot_data_frame_distance) +
  ...
  #           colour = "orange") +
  labs(title = "Gaussian Kernel Cruve With Selected Smoothing Factors", y = "Kernel Output",
...
ggplot(plot_data_frame_hour) +
  ...
  #
  labs(title = "Gaussian Kernel Cruves With Selected Smoothing Factors", y = "Kernel Output",
       x = "Hour", color = "Legend") +
...
predict_weather = function(u_latitude, u_longtitude, u_date, u_type) {
  ...
  for (i in 1:length(times)) {
    ...
    if (u_type == "sum") {
      ...
      kernel = kernel_sum(user_data_point, st, h_distance, h_distance, h_time)
    }
    else if (u_type == "prod") {
      # Parameters: A, B, h_distance, h_date, h_time
      kernel =
...
# Students' code here
pred_temp_sum = predict_weather(a, b, date, "sum")
pred_temp_prod = predict_weather(a, b, date, "prod")
plot_data_frame =
